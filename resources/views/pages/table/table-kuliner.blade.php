...
@section('content')
    <div class="container">
        <div class="table-responsive">
            <div class="table-wrapper">
                        ...
                        @foreach ($kuliners as $kuliner)
                            <tr>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="selectAll"
                                            onchange="updateCheckboxes()" value="{{ $kuliner->id }}">
                                ...
                                <td>
                                    ...
                                    <a href="#" class="delete" data-bs-toggle="modal"
                                        data-bs-target="#deleteKulinerModal" data-kuliner-id="{{ $kuliner->id }}">
                ...
                <div class="clearfix">
                    <div class="hint-text">Showing <b>{{ $kuliners->firstItem() }}</b> to
                        <b>{{ $kuliners->lastItem() }}</b> of
                        <b>{{ $kuliners->total() }}</b> entries
                    </div>
                    <ul class="pagination">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content text-white">
                <form method="POST" action="{{ route('kuliner.store') }}">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="addKulinerModalLabel">Add kuliner</h5>
    ...
    <div class="modal fade" id="deleteSelectedKulinerModal" tabindex="-1"
        aria-labelledby="deleteSelectedKulinerModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content text-white">
                <div class="modal-header">
                    <h4 class="modal-title" id="deleteSelectedKulinerModalLabel">Delete Kuliner</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete these records?</p>
